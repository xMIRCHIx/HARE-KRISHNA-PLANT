...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    guide: {
      ...
      sec3Desc: 'If raw material consumption spikes, machine downtime wastes wet mix, or material purchase rates rise such that 1 brick costs more than ₹4.00 to make (e.g. ₹4.15/brick), the system instantly highlights that day in bright RED with a LOSS WARNING banner so the owner can review raw material usage and operational efficiency.',
